...
@Singleton
@Path(RepositoriesApiResource.RESOURCE_URI + "/r/proxy")
public class RProxyRepositoriesApiResource
    extends AbstractRepositoriesApiResource<RProxyRepositoryApiRequest>
{
  ...
  @Validate
  @Override
  public Response createRepository(final RProxyRepositoryApiRequest request) {
