...
{
  @Inject
  public RHostedRepositoriesApiResource(
  ...
  @ApiOperation("Create R hosted repository")
  @ApiResponses(value = {
  ...
  @Validate
  @Override
  public Response createRepository(final RHostedRepositoryApiRequest request) {
