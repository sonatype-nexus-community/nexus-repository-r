 ...
 */
package org.sonatype.nexus.plugins.r.internal.fixtures;
...
class RepositoryRuleR
    extends RepositoryRule
    implements RRepoRecipes
{
  RepositoryRuleR(final Provider<RepositoryManager> repositoryManagerProvider) {
