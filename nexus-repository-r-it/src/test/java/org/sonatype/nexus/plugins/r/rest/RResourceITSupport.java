...
public class RResourceITSupport
    extends RepositoryITSupport
{
  private static final String FORMAT_VALUE = RFormat.NAME;
  ...
  public static final String HOSTED2_NAME = HOSTED_NAME + "-2";

  public static final String GROUP_NAME = String.format("%s-%s", FORMAT_VALUE, GroupType.NAME);

  public static final String MEMBER_NAME = GROUP_NAME + "-member";
